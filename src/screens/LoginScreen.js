...
function LoginScreen(props) {
  ...
  Alert.alert(
    ...
    "Заполните пожалуйста оба поля: телефон и пароль",
    [
      {
        text: "OK", onPress: () => {
  ...
  return (
    <View style={styles.container}>
          ...
          <View style={styles.icon4Row}>
            ...
            {/* <TextInputMask
              ...
              onChangeText={(formatted, extracted) => {
                ...
                setUsername(extracted) // 1234567890
              }}
      ...
      <TouchableOpacity   onPress={() => submit()} >
        <MainButton buttonText={isLoading?"Проверка...":"ВОЙТИ"} style={styles.mainButton}></MainButton>
      </TouchableOpacity>
          ) : ( 
      <TouchableOpacity   onPress={() => createTwoButtonAlert2()} >
        <MainButton buttonText="ВОЙТИ" style={styles.mainButtonBold}></MainButton>
      </TouchableOpacity>
          )}

      <Text style={styles.greyText2}>Если вы еще не зарегистрировались в сервисе нажмите кнопку</Text>
      <TouchableOpacity   onPress={() => navigation2.navigate("RegistScreen")} >
        <MainButton buttonText="ЗАРЕГИСТРИРОВАТЬСЯ" style={styles.mainButton2}></MainButton>
      </TouchableOpacity>
{/*       
      <View style={styles.anotherButtons}>
